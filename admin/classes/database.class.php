...
if (!defined("_DB_CLASS")) {
	...
	*/
	...
	class database {
		...
		*/
		static function get_fields_names($table_name)
		{
		...
		*/
		static function insert ($table_name, $array)
		{
		...
		*/
		static function query ($sql)
		{
			...
			if (!$temp_res = @mysql_unbuffered_query($sql))
			{
				...
				die (mysql_error() . '<br>sql <b>'.$sql.'</b>');
				return false;
			} else {
		...
		*/
		static function update ($table_name, $arr, $where)
		{
