...
require_once('edit_table_button_basic.class.php');

class edit_table_button_add extends edit_table_button_basic {
	protected $form_name = '';


	public function __construct() {
		// set default parameters for the button
		$this->set_caption('Add');
	}
	...
	*/
	public function get_javascript() {
		...
		*/
		...
		$this->set_javascript($js_code, 'add');
		return $js_code;
	}
	...
	*/
	public function get_html() {
		...
		$this->image 		= 'edit_table/images/add.png';
		$this->img_height 	= 16;
		$this->img_width 	= 16;
